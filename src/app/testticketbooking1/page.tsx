...
export default function TestTicketBooking1() {
  return (
    <div style={{ padding: '2rem', backgroundColor: '#fdf0f0', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        <h1 style={{ color: '#571a15', marginBottom: '2rem', textAlign: 'center' }}>Test Ticket Booking 1</h1>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
              <div style={{ flex: '1 1 200px' }}>
                <label style={{ display: 'block', fontSize: '0.9rem', color: '#666', marginBottom: '0.5rem' }}>Gothram <span style={{color: 'red'}}>*</span></label>
                <input type="text" style={inputStyle} />
              </div>
              <div style={{ flex: '1 1 200px' }}>
                <label style={{ display: 'block', fontSize: '0.9rem', color: '#666', marginBottom: '0.5rem' }}>Email Address <span style={{color: 'red'}}>*</span></label>
        ...
        <div style={{ backgroundColor: 'white', borderRadius: '12px', padding: '1.5rem', marginBottom: '1.5rem', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
          <h2 style={{ fontSize: '1.2rem', color: '#333', marginBottom: '1.5rem', fontWeight: 'bold' }}>Pilgrim Details</h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '1.5rem' }}>
                <div style={{ flex: '1 1 200px', maxWidth: 'calc(35% - 0.75rem)' }}>
