    ...
    <>
      <section className="hero animate-fade-in" style={{ height: '30vh', minHeight: '30vh', background: 'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url("/srirangam/hero-bg.png") center/cover no-repeat' }}>
        <div className="container hero-content">
          <h1 style={{ marginTop: '0' }}>Transport Information</h1>
          <div className="subtitle">How to Reach Srirangam</div>
        </div>
      </section>
      ...
      <section className="section" style={{ backgroundColor: '#fdfaf4' }}>
        <div className="container" style={{ maxWidth: '1000px' }}>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: 1.8, color: '#444', textAlign: 'center', marginBottom: '3rem' }}>
            Sri Ranganathaswamy Temple is located on Srirangam Island in Tiruchirappalli (Trichy), Tamil Nadu. The temple is well connected by air, rail and road, making it easy for devotees from across India and abroad to visit.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', borderTop: '4px solid #d95c14' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', color: '#571a15' }}>
                <Bus size={28} />
                <h2 style={{ margin: 0, fontSize: '1.5rem' }}>Local Bus Stands</h2>
              </div>
              
              <div style={{ marginBottom: '1.5rem' }}>
                <h3 style={{ margin: '0 0 0.5rem 0', color: '#d95c14', fontSize: '1.1rem' }}>From Chathiram Bus Stand</h3>
                <div style={{ display: 'flex', gap: '1rem', color: '#666', fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                  <span><MapPin size={14} style={{display:'inline'}}/> ~5 km</span>
                  <span>⏱ 15–20 mins</span>
                </div>
                <ul style={{ margin: 0, paddingLeft: '1.2rem', color: '#444', fontSize: '0.95rem' }}>
                  <li>Frequent city buses to Srirangam.</li>
                  <li>Auto-rickshaws readily available.</li>
                  <li>Taxis and app-based cabs offer direct drop.</li>
                </ul>
              </div>
              
              <div style={{ marginBottom: '1.5rem' }}>
                <h3 style={{ margin: '0 0 0.5rem 0', color: '#d95c14', fontSize: '1.1rem' }}>From Trichy Central Bus Stand</h3>
                <div style={{ display: 'flex', gap: '1rem', color: '#666', fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                  <span><MapPin size={14} style={{display:'inline'}}/> ~10 km</span>
                  <span>⏱ 25–35 mins</span>
                </div>
                <ul style={{ margin: 0, paddingLeft: '1.2rem', color: '#444', fontSize: '0.95rem' }}>
                  <li>City buses operate regularly.</li>
                  <li>Autos and taxis available outside terminal.</li>
                  <li>Recommended for families travelling with luggage.</li>
                </ul>
              </div>

              <div>
                <h3 style={{ margin: '0 0 0.5rem 0', color: '#d95c14', fontSize: '1.1rem' }}>From Panjapur Integrated Terminus</h3>
                <div style={{ display: 'flex', gap: '1rem', color: '#666', fontSize: '0.9rem', marginBottom: '0.5rem' }}>
                  <span><MapPin size={14} style={{display:'inline'}}/> ~15–18 km</span>
                  <span>⏱ 30–45 mins</span>
                </div>
                <ul style={{ margin: 0, paddingLeft: '1.2rem', color: '#444', fontSize: '0.95rem' }}>
                  <li>Direct or connecting buses.</li>
                  <li>Allow extra time during peak traffic.</li>
                </ul>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              ...
              <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', borderTop: '4px solid #c28e5e' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', color: '#571a15' }}>
                  <Train size={28} />
                  <h2 style={{ margin: 0, fontSize: '1.5rem' }}>Railway Stations</h2>
                </div>
                
                <div style={{ marginBottom: '1rem' }}>
                  <h3 style={{ margin: '0 0 0.25rem 0', color: '#c28e5e', fontSize: '1.1rem' }}>Srirangam Railway Station</h3>
                  <p style={{ margin: 0, color: '#444', fontSize: '0.95rem' }}>~1.5 km from the temple. Easily accessible by walk, auto or taxi.</p>
                </div>
                <div>
                  <h3 style={{ margin: '0 0 0.25rem 0', color: '#c28e5e', fontSize: '1.1rem' }}>Tiruchirappalli Junction</h3>
                  <p style={{ margin: 0, color: '#444', fontSize: '0.95rem' }}>~10 km from the temple. City buses, autos and taxis available outside.</p>
                </div>
              </div>
              ...
              <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', borderTop: '4px solid #15803d' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem', color: '#571a15' }}>
                  <Plane size={28} />
                  <h2 style={{ margin: 0, fontSize: '1.5rem' }}>By Air</h2>
                </div>
                
                <div style={{ display: 'flex', gap: '1rem', color: '#666', fontSize: '0.9rem', marginBottom: '1rem' }}>
                  <span><MapPin size={14} style={{display:'inline'}}/> ~15 km to Airport</span>
                  <span>⏱ 30–40 mins travel</span>
                </div>
                <p style={{ margin: '0 0 1rem 0', color: '#444', fontSize: '0.95rem', lineHeight: 1.6 }}>
                  Trichy International Airport has domestic connectivity to Chennai, Bengaluru, Hyderabad, Mumbai, Delhi and Kochi, along with international flights to Singapore, Kuala Lumpur, Colombo and Gulf destinations.
                </p>
                <ul style={{ margin: 0, paddingLeft: '1.2rem', color: '#444', fontSize: '0.95rem' }}>
                  <li>24×7 prepaid taxis & App-based cabs.</li>
                  <li>Airport buses to city with Srirangam connections.</li>
                </ul>
              </div>
            </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', color: '#571a15' }}>
                <Train size={24} />
                <h2 style={{ margin: 0, fontSize: '1.3rem' }}>Train Travel from Major Cities</h2>
              </div>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #eee', color: '#d95c14' }}>
                    <th style={{ padding: '0.75rem 0' }}>City</th>
                    <th style={{ padding: '0.75rem 0' }}>Distance</th>
            ...
            <div style={{ backgroundColor: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem', color: '#571a15' }}>
                <Car size={24} />
                <h2 style={{ margin: 0, fontSize: '1.3rem' }}>By Road (Driving)</h2>
              </div>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.95rem' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid #eee', color: '#d95c14' }}>
              ...
              <div style={{ marginTop: '2rem', paddingTop: '1.5rem', borderTop: '1px solid #eee' }}>
                <h3 style={{ margin: '0 0 0.5rem 0', color: '#571a15', fontSize: '1.1rem' }}>Parking Information</h3>
                <p style={{ margin: 0, color: '#444', fontSize: '0.95rem', lineHeight: 1.6 }}>
                  Dedicated parking is available around the temple. During weekends and major festivals (like Vaikunta Ekadasi), arrive early as parking fills quickly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: '#fffbeb', border: '1px solid #fef3c7', borderLeft: '5px solid #f59e0b', padding: '2rem', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem', color: '#b45309' }}>
              <AlertCircle size={28} />
              <h2 style={{ margin: 0, fontSize: '1.4rem' }}>Travel Tips</h2>
            </div>
            <ul style={{ margin: 0, paddingLeft: '1.5rem', color: '#92400e', fontSize: '1rem', lineHeight: 1.8 }}>
              <li>Arrive at least 30 minutes before the queue closing time.</li>
              <li>Expect additional traffic during festivals.</li>
              <li>If your train stops at Srirangam Station, alight there for the shortest transfer.</li>
